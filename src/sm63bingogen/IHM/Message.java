...
public class Message {
    ...
    private Message() {
        ...
        addMessage("title","SM63BingoGen 1.1");
        
        addMessage("about", "\nSuper Mario 63 Bingo Generator version 1.1.\n"
                + "Created by Sekanor.\n"
        ...
        addMessage("e_noJson","No JSON has been generated.");
    }
    ...
    public static String get(String title) {
        return Message.getInstance().messageList.get(title);
    }
